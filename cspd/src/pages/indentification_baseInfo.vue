  ...
  <div>
    <el-card class="box-card">
      ...
      <p class="info-bar">
        ...
        <span class="base-text">{{roleName}}</span>
      </p>
  ...
  export default {
    data() {
      return {
        ...
        authenticationStatus:parseInt(getStore("authenticationStatus")),
        roleName:JSON.parse(getStore("userMesage")).roleType ? "平台医生" : "健管师"
      }
    },
    methods:{

...
<script>
import {  ERR_OK,getListWithNoParam,PostUpdateRole,PostDeleteRole,PostSaveRole,getListRole,getRoleInfo,getDictListByType,getSysMenuByCategory } from '@/api/api.js'

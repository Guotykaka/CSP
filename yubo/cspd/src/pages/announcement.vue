      ...
      <div class="bgColor">
        ...
        <div class="announ-table">
          <el-table
            ...
            <el-table-column prop="dictName" label="类型" width="180" align="center"></el-table-column>
            <el-table-column prop="lastUpdateTime" label="发布时间" align="center"></el-table-column>

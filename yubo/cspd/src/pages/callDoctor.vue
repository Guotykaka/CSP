          ...
          <li class="detail-li" v-for="(item,index) in insLeaveDetail" :key="item.insLeaveWordId">
            ...
            <div class="detail-main">
              ...
              <transition-group name="fade" tag="div">
                <div v-show="checkId===index" v-for="(item1,index1) in insLeaveAnswerlist" :key="index1">
                  <div class="re-circle">
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      this.createUserId = EncodeDoctorId(this.userInfo.userId);
      this.insDoctorId = EncodeDoctorId(this.userInfo.insDoctorId);

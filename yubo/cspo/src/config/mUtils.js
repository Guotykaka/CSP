...
export function EncodeUserId(id) {
  let EncodeId = base64Class.decode(id);
...
//通用alert
export function IsAlert(msg, words, type,) {
  MessageBox.confirm(msg, words, {center: true, type: type, showCancelButton: false}).then().catch(() => {
  });
}

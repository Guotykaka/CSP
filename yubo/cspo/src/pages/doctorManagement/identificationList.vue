  ...
  <div class="page-wrapper">
    ...
    <div class="page-container">
      ...
      <el-table
        ...
        border
        style="width: 100%">
        <el-table-column show-overflow-tooltip align="center" prop="loginName" label="医生姓名"  width="100"></el-table-column>
        <el-table-column show-overflow-tooltip align="center" prop="institutionName" label="机构"></el-table-column>
        ...
        <el-table-column show-overflow-tooltip align="center" prop="authenticationStatus" label="状态" width="100">
      ...
      <el-dialog title="认证详情" :visible.sync="isShowDialog" width="70%">
        ...
        <el-row :gutter="20" class="m_b_15">
          ...
          <el-col :span="7">
            <img class="logoImg" :src="doctorInfo.userIcon"/>
          </el-col>
        </el-row>
        <el-row :gutter="20" class="m_b_15">
          <el-col :span="5" style="text-align: right">

  ...
  <div class="page-wrapper">
    ...
    <div class="page-container">
      ...
      <el-table
        ...
        <el-table-column show-overflow-tooltip align="center" prop="username" label="申请人"></el-table-column>
        <el-table-column show-overflow-tooltip align="center" prop="createTime" label="申请时间"></el-table-column>
        <el-table-column show-overflow-tooltip align="center" prop="institutionName" label="申请人所在机构"></el-table-column>
        <el-table-column show-overflow-tooltip align="center" prop="disburse" label="申请金额"></el-table-column>

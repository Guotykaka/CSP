<template>
  <div class="page-wrapper">
    ...
    <div class="page-container">
      ...
      <!-- 商品新增弹窗 -->
      <div class="shop-add" v-if="dialogAddVisible">
  ...
  export default {
    ...
    data() {
      return {
        ...
        categoryOneList: [],//一级类目下拉框数据
        categoryTwoList: [],//二级类目下拉框数据
    ...
    methods: {
      ...
      getCategory(value) {
        ...
        GetProductCategerySelect(params)
          .then((res) => {
            if (res.code === ERR_OK) {
              if (params.categoryLevel === 1) {
                this.categoryOneList = res.data;
              } else if (params.categoryLevel === 2) {
      ...
      handleCloseAdd() {
        ...
        // this.addTable.initialQuantity = 0;
        // this.addTable.keyWord = "";
        // this.addTable.modelType = "50";
        ...
        // this.addTable.productUnix = "元";
        // this.addTable.roleId = "";
        // this.addTable.supplierId = "";
        // this.addTable.useOs = 1;
        // this.addTable.userId = "";
        this.addTable = {
          initialQuantity: 0,
          keyWord: "",
          commTagDetailEntities: [],

  ...
  <div class="page-wrapper" id="scroller">
    ...
    <div class="page-container">
      ...
      <div>
        ...
        <el-main class="my-table-report" v-loading.fullscreen.lock="loading"
          ...
          <template>
            <el-table :data="tableData" border style="width: 100%" id="app" height="650" :header-cell-class-name="tableheaderClassName">
              ...
              <el-table-column show-overflow-tooltip align="center" prop="date" label="时间" min-width="110"></el-table-column>
              <el-table-column show-overflow-tooltip align="center" prop="unitName" label="机构" min-width="110"></el-table-column>
              <el-table-column show-overflow-tooltip align="center" prop="newAddCount" label="新增用户数" min-width="110"></el-table-column>
              <el-table-column show-overflow-tooltip align="center" prop="getReportUserCount" label="获取报告人数" min-width="110"></el-table-column>
              <el-table-column show-overflow-tooltip align="center" prop="getReportCount" label="获取报告份数" min-width="110"></el-table-column>
              <el-table-column show-overflow-tooltip align="center" prop="perCapitalCount" label="人均获取份数" min-width="110"></el-table-column>
              <el-table-column label="获取报告人数" class-name='reportNum' align="center">
              <el-table-column show-overflow-tooltip align="center" prop="smsGetReportUserCount" label="短信"></el-table-column>
              <el-table-column show-overflow-tooltip align="center" prop="groundExtensionGetReportUserCount" label="地推"></el-table-column>
              <el-table-column show-overflow-tooltip align="center" prop="netGetReportUserCount" label="网络"></el-table-column>
              </el-table-column>
            </el-table>
          </template>
...
<script>
import { ERR_OK,GetReportStaticsList,getAllins} from '@/api/api.js'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      GetReportStaticsList(params).then(response => {
         if ((response.code === ERR_OK)) {
          this.tableData = [];
          this.tableData = response.data;
          this.loading = false;
        } else {
          this.$alert('获取报告统计数据失败', this.title,{center:true});
          this.loading = false;
        }
      }).catch(() => {
          this.$message.error('网络错误，请稍后重试');

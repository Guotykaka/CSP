  ...
  <div class="login-container">
    <div class="login-box">
      ...
      <ul>
        ...
        <li class="m_b_20">
          <el-input type="password" v-model="loginParams.password" placeholder="请输入密码"   @keyup.enter.native="doLogin()"></el-input>
        </li>
        <li class="m_b_20">
...
<script>
  //引入login的方法
  import {login,ERR_OK,getLeftNav} from "@/api/api.js";
    ...
    created(){
      ...
      methods:{
        ...
        refreshImg:function () {
          ...
          this.imgUrl = baseUrl+"system/user/captcha.jpg/"+this.loginParams.codeKey
        }
      }
    }
</script>
